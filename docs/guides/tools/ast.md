...
| `where.flows_to` | object |  |  | Leaf: capture A flows to capture B inside the declaration named by within; e.g. { from: X, to: Y, within: FN }. |
