...
// SubCollector collects resources of a specific type from a cloud provider.
...
type SubCollector interface {
	...
	// (e.g. "ec2-instances", "gke-clusters").
	Name() string

	// Collect discovers resources and returns them as specs.
