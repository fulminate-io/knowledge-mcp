...
// GraphName is THE ONE DEFINITION of the graph name a Bitbucket collect lands
// under: the "bitbucket-" prefix joined to the org/workspace id the collect was
// handed.
//
// TWO PRODUCTION CALLERS READ THIS ONE ANSWER. BitbucketCollector.Collect fills
...
func GraphName(id string) string { return "bitbucket-" + id }
