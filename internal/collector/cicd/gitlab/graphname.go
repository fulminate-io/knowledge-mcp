...
// GraphName is THE ONE DEFINITION of the graph name a GitLab collect lands
// under: the "gitlab-" prefix joined to the org/workspace id the collect was
// handed.
//
// TWO PRODUCTION CALLERS READ THIS ONE ANSWER. GitLabCollector.Collect fills
...
func GraphName(id string) string { return "gitlab-" + id }
