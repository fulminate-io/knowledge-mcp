...
//
// Build spawns the page-processing goroutine (build.go:221). A PDF chunk build
// that returns early — a malformed document, a cancelled context — can leave that
// goroutine working through pages nobody will read.
//
