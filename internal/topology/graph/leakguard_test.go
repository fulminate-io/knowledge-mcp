...
//
// This package's goroutines are TEST-side: edgeless_test.go drives graph analysis
// concurrently. Production analysis here is synchronous. The guard protects against
// a driver goroutine outliving its test while still walking a graph the test has
// finished with.
//
