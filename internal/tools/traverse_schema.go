	...
	return kgtools.MCPTool{
		...
		InputSchema: kgtools.InputSchema{
			...
			Properties: map[string]kgtools.Property{
				...
				"language":              {Type: "string", Description: "LEGACY read-only selector naming a pre-singleton practice graph (e.g. 'go', 'python'). Practice is ONE combined graph now; omit this to traverse it."},
