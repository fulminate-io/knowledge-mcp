...
// help_content_ast_reference.go — the second half of the help("ast") topic.
// See help_content_ast.go for why the topic is split and where the seam is.

package tools

const helpAstResults = `## Union compile, the compiled disclosure, and the 'context' pin
