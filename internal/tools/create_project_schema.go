	...
	return kgtools.MCPTool{
		...
		InputSchema: kgtools.InputSchema{
			...
			Properties: map[string]kgtools.Property{
				...
				"summary":     {Type: "string", MaxLength: 255, Description: "Required search-optimized one-line summary. Synced to the Linear project description (tagline), which caps at 255 chars — keep it tight. See docs/node-type-llm-defaults.md."},
