	...
	return kgtools.MCPTool{
		...
		InputSchema: kgtools.InputSchema{
			...
			Properties: map[string]kgtools.Property{
				...
				"language":   {Type: "string", Description: "REFUSED on a practice delete, and it addresses no other family's graph. Practice is ONE combined graph, so narrow by `source` (a hub id) instead."},
