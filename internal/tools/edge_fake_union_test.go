...
// node-set incidence when the plan carries ids.
//
...
//
// This file is DUPLICATED verbatim in cmd/knowledge/internal/thought. Go test symbols
...
// version-skewed server. THIS PACKAGE NEEDS IT EVEN THOUGH IT CONVERTS NO READER OF
// ITS OWN: its tests drive thought-package readers that ARE banded.
//
...
// lower, exclusive upper, empty meaning unbounded.
//
// Like the rest of this file it is DUPLICATED verbatim in cmd/knowledge/internal/thought:
// Go test symbols are not importable across packages, and the architecture invariant
// forbids a hand-written shared package. The shape is the reuse, not the code.
