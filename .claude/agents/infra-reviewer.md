...
<constraint id="read-only" severity="hard">
  ...
  record_decision (decisions belong to the user and the brainstorm/orchestrator; surface the choice in your report), create_plan, create_research, create_test_plan,
